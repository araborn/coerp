...
(:~
 ...
 :)
module namespace helpers="http://localhost:8080/exist/apps/coerp_new/helpers";
...
:)
 declare function helpers:stylesheet($node as node(), $model as map(*), $path as xs:string) {
    <link rel="stylesheet" type="text/css" href="http://localhost:8080/exist/apps/coerp_new/{$path}"/>
 };
 ...
 declare function helpers:script($node as node(), $model as map(*), $path as xs:string) {
    <script type="text/javascript" src="http://localhost:8080/exist/apps/coerp_new/{$path}"></script>
 };
