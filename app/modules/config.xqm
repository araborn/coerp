...
(:~
 ...
 : within a module.
 :)
module namespace config="http://localhost:8080/exist/apps/coerp_new/config";
import module namespace helpers="http://localhost:8080/exist/apps/coerp_new/admin" at "admin.xqm";
...
;
declare variable $config:conf-file := doc("/db/apps/coerp_new/conf.xml");
